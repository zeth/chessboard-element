...
;(function () {
  ...
  class ChessBoardElement extends HTMLElement {
    ...
    constructor () {
      ...
      const drawBoard = () => {
        $board.html(buildBoardHTML(this.currentOrientation, squareSize, config.showNotation))
        drawPositionInstant()
      ...
      const beginDraggingPiece = (source, piece, x, y) => {
        ...
        if (isFunction(config.onDragStart) &&
            config.onDragStart(source, piece, deepCopy(this.currentPosition), this.currentOrientation) === false) {
          return
        }
