  ...
  class ChessBoardElement extends HTMLElement {
    ...
    constructor () {
      ...
      const initDOM = () => {
        ...
        this.$board = $(this._container.querySelector('.' + CSS.board));

        if (config.sparePieces) {
          this.$sparePiecesTop = $(this._container.querySelectorAll('.' + CSS.sparePiecesTop));
          this.$sparePiecesBottom = $(this._container.querySelectorAll('.' + CSS.sparePiecesBottom));
        }
