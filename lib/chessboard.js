...
;(function () {
  ...
  class ChessBoardElement extends HTMLElement {
    ...
    snapbackDraggedPiece() {
      ...
      $(this._draggedPiece).animate(sourceSquarePosition, opts);
    ...
    trashDraggedPiece() {
      ...
      $(this._draggedPiece).fadeOut(this.config.trashSpeed);
    ...
    dropDraggedPieceOnSquare(square) {
      ...
      $(this._draggedPiece).animate(targetSquarePosition, opts);
