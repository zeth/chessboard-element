    ...
    constructor () {
      ...
      const beginDraggingPiece = (source, piece, x, y) => {
        ...
        if (isFunction(config.onDragStart) &&
            config.onDragStart(source, piece, deepCopy(this.currentPosition), currentOrientation) === false) {
          return
        }
      ...
      const updateDraggedPiece = (x, y) => {
        ...
        draggedPieceElement.style.left = `${x - squareSize / 2}px`;
        draggedPieceElement.style.top = `${y - squareSize / 2}px`;
      ...
      const stopDraggedPiece = (location) => {
        ...
        if (isFunction(config.onDrop)) {
          ...
          var oldPosition = deepCopy(this.currentPosition)
      ...
      const mousedownSquare = (evt) => {
        ...
        beginDraggingPiece(square, this.currentPosition[square], evt.pageX, evt.pageY)
      }
      ...
      const mouseenterSquare = (evt) => {
        ...
        config.onMouseoverSquare(square, piece, deepCopy(this.currentPosition), currentOrientation)
      }
      ...
      const mouseleaveSquare = (evt) => {
        ...
        // execute their function
        config.onMouseoutSquare(square, piece, deepCopy(this.currentPosition), currentOrientation)
      }
