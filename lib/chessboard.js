...
export class ChessBoardElement extends HTMLElement {
  ...
  static get observedAttributes() {
    return ['position', 'hide-notation', 'orientation', 'draggable-pieces',
        'drop-off-board', 'piece-theme', 'move-speed', 'snapback-speed',
        'snap-speed', 'trash-speed', 'appear-speed', 'spare-pieces'];
  }
